...
# 
# PASO 2: Función para cargar y limpiar los datos 
# 
def load_data(path):
    # Lee archivo CSV comprimido en zip
    ...
    # Ajusta valores > 4 en EDUCATION a 4
    df["EDUCATION"] = df["EDUCATION"].apply(lambda x: 4 if x > 4 else x)

    # Retorna dataset limpio sin NaN
    return df.dropna()


# 
# PASO 3: Función para calcular métricas del modelo
# 
...
# 
# PASO 4: Función para construir matriz de confusión
# 
...
# 
# PASO 5: Función principal del programa
# 
def main():
    ...
    # 
    # PASO 5.10: Guardar métricas en JSON
    # 
...
# 
# PASO 6: Ejecutar función principal
# 
